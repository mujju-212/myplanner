  ...
  useEffect(() => {
    if (id) {
      ...
      if (habit) {
        ...
        setFrequency(habit.frequency_type as HabitFrequency);
        setSpecificDays(habit.specific_days || []);
        setTimesPerWeek(String(habit.times_per_week || 3));
        setTimeOfDay(habit.time_of_day as HabitTimeOfDay);
  ...
  return (
    <View style={[styles.container, { backgroundColor: tc.background }]}>
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.headerTitle, { color: tc.textPrimary }]}>Edit Habit</Text>
