...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, fontSize: 22, fontFamily: typography.semiBold },
  clearBtn: { paddingVertical: 6, paddingHorizontal: 12 },
  clearBtnText: { fontSize: 14, fontFamily: typography.medium },
  countRow: { paddingHorizontal: 20, paddingBottom: 8 },
  countText: { fontSize: 13, fontFamily: typography.regular },
  ...
  notifContent: { flex: 1 },
  notifTitle: { fontSize: 15, fontFamily: typography.semiBold, marginBottom: 2 },
  notifBody: { fontSize: 13, fontFamily: typography.regular, marginBottom: 4 },
  triggerRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  triggerText: { fontSize: 11, fontFamily: typography.regular },
  emptyContainer: {
    flex: 1, alignItems: 'center', justifyContent: 'center',
    paddingHorizontal: 40, paddingTop: 60,
  },
  emptyTitle: { fontSize: 18, fontFamily: typography.semiBold, marginTop: 16, textAlign: 'center' },
  emptySubtitle: { fontSize: 14, fontFamily: typography.regular, marginTop: 8, textAlign: 'center', lineHeight: 20 },
});
