  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await addGoal({
        ...
        unit: unit || undefined, duration_type: duration, priority,
        color: goalColor, start_date: startDate, end_date: endDate || undefined,
  ...
  return (
    <View style={[styles.container, { backgroundColor: tc.background }]}>
      ...
      <View style={styles.header}>
        <Pressable onPress={() => router.back()} style={styles.backBtn}><MaterialIcons name="arrow-back" size={28} color={tc.textPrimary} /></Pressable>
        <Text style={[styles.headerTitle, { color: tc.textPrimary }]}>New Goal</Text>
      ...
      <View style={styles.bottomBar}>
        <Pressable onPress={handleSave}>
          <LinearGradient colors={['#4CAF50', '#2E7D32']} style={styles.mainSaveGradient} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}>
            <Text style={styles.mainSaveText}>Create Goal</Text>
          </LinearGradient>
        </Pressable>
      </View>
    </View>
